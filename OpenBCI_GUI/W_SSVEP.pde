...
class W_SSVEP extends Widget {
    ...
    void update(){
        ...
        if ((topNav.configSelector.isVisible != configIsVisible) || (topNav.layoutSelector.isVisible != layoutIsVisible)) {
            ...
            if (topNav.configSelector.isVisible || topNav.layoutSelector.isVisible) {
                ...
                cp5_ssvepDropdowns.getController("port_name").unlock();
    ...
    void draw(){
        ...
        if(ssvepDisplay == 0){  // 1 SSVEP
            ...
            // textSize(15);
            // fill(100);
            // text("Frequency (Hz)", x + w/2 - h/8 , y + 30);
            ...
            // textSize(15);
            // fill(100);
            // text("Frequency (Hz)", x + w/4 - h/8, y + h/3 - 10);
            cp5_ssvepDropdowns.getController("Frequency 1")
            ...
            // textSize(15);
            // fill(100);
            // text("Frequency (Hz)", x + w/8 - h/8, y + h/3 - 10);
            ...
            resetDropdowns();   //set all dropdowns invisble
            // upper - left side label
            // textSize(15);
            // fill(100);
            // text("Frequency (Hz)", x + w/4 - h/12, y + h/4 -70);
