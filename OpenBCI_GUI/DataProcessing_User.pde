...
Serial hand = null;//new Serial(this, Serial.list()[32], 38400);
...
class DataProcessing_User {
  ...
  public void process(float[][] data_newest_uV, //holds raw bio data that is new since the last call
    ...
    //  //=========================== EYEBROW =======================================
    //  if(output_normalized_R >= tripThreshold  && !switchTripped_R && (millis() - timeOfLastTrip_R) >= 1000){
    //    switchTripped_R = true;
    //    switchBrowCounter++;
    //    timeOfLastTrip_R = millis();
    //  }
    //  if(switchTripped_R && output_normalized_R <= untripThreshold){
    //    switchTripped_R = false;
    //  }
    ...
    //  switch(switchCounter){
    //      case 1:
    //        //println("Single Jaw Clench");
    //        break;
    //      case 2:
    //        //println("Two Jaw Clenches");
    //        break;
    //      case 3:
    //        //println("Three Jaw Clenches");
    //        break;
    //      case 4:
    //        //println("Four Jaw Clenches");
    //        break;
    //      //case 5:
    //      //  println("Five Jaw Clenches");
    //      //  break;
    //      //case 6: 
    //      //  println("Six Jaw Clenches");
    //      //  break;
    //      default:
    //        switchCounter = 0;
    //    }
  ...
  //    //Bar to mark top threshold
  //    fill(255,0,0);
  //    rect(13*(width/16), 3*(height/8) +  map(output_normalized_L, 0, 1, 0, (-1) * (height/4)) * tripThreshold, (width/64), 5);
  //    fill(0,0,50);
  //    rect(13*(width/16), 3*(height/8) +  map(output_normalized_L, 0, 1, 0, (-1) * (height/4)) * untripThreshold, (width/64), 5);
  //    popMatrix();
  ...
  //    //Bar to mark thresholds
  //    fill(255,0,0);
  //    rect(13*(width/16), 3*(height/8) +  map(output_normalized_R, 0, 1, 0, (-1) * (height/4)) * tripThreshold, (width/64), 5);
  //    fill(0,0,50);
  //    rect(13*(width/16), 3*(height/8) +  map(output_normalized_R, 0, 1, 0, (-1) * (height/4)) * untripThreshold, (width/64), 5);
  //    popMatrix();
  ...
  //    //Bars to mark thresholds
  //    fill(255,0,0);
  //    rect(13*(width/16), 3*(height/8) +  map(output_normalized, 0, 1, 0, (-1) * (height/4)) * tripThreshold, (width/64), 5);
  //    fill(0,0,50);
