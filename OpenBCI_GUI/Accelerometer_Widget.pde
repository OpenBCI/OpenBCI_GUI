...
//  Accelerometer_Widget(int NCHAN, float sample_rate_Hz, Container container, PApplet p, OpenBCI_ADS1299 _OBCI,int _topMargin) {
...
//  public void process(float[][] auxBuffLocal) {              //holds the FFT (frequency spectrum) of the latest data
